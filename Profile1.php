...
<body>
    <div id="profilehead">
        <div style="margin:auto;font-size:30px;width:800px;font-family:fantasy;"> TRAVLOG
            ...
            <img src="https://images.pexels.com/photos/697509/pexels-photo-697509.jpeg?cs=srgb&dl=pexels-andrew-personal-training-697509.jpg&fm=jpg" alt="profile1" style="width:40px;float:right;border-radius:100px;">
    ...
    <div style="width: 1000px;margin:auto;background-color:whitesmoke;min-height:300px;">
        <div style="background-color:white;text-align:center;">
            <img src="https://images.pexels.com/photos/235621/pexels-photo-235621.jpeg?cs=srgb&dl=pexels-pixabay-235621.jpg&fm=jpg" alt="CoverPic" style="width:85%;">
            <img id="profilepic" src="https://images.pexels.com/photos/697509/pexels-photo-697509.jpeg?cs=srgb&dl=pexels-andrew-personal-training-697509.jpg&fm=jpg" alt="ProfilePic">
            <br>
            <div style="font-size:20px;"> Sam Mendes </div>
            <br>
            <!--Navigation Section-->
            <div id="nav">Home</div>
            ...
            <div id="profilebody">
                ...
                <div id="friendslist">TRAVELLERS
                    ...
                    <div>
                        <img src="https://images.pexels.com/photos/1382731/pexels-photo-1382731.jpeg?cs=srgb&dl=pexels-tu%E1%BA%A5n-ki%E1%BB%87t-jr-1382731.jpg&fm=jpg" alt="profile3" style="width:75px;">
                ...
                <!--Photos Section-->
                <div id="Photos">CANADA TRAVEL

                    <?php include "photoscanada.php"; ?>
