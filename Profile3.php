...
<body>
    <div id="profilehead">
        <div style="margin:auto;font-size:30px;width:800px;font-family:fantasy;"> TRAVLOG
            ...
            <img src="https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?cs=srgb&dl=pexels-andrea-piacquadio-774909.jpg&fm=jpg" alt="profile1" style="width:40px;float:right;border-radius:100px;">
        </div>
    </div>
    <!--Profile Section-->
    <div style="width: 1000px;margin:auto;background-color:whitesmoke;min-height:300px;">
        <div style="background-color:white;text-align:center;">
            <img src="https://images.pexels.com/photos/6336038/pexels-photo-6336038.jpeg?cs=srgb&dl=pexels-tom-d%27arby-6336038.jpg&fm=jpg" alt="CoverPic" style="width:85%;">
            <img id="profilepic" src="https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?cs=srgb&dl=pexels-andrea-piacquadio-774909.jpg&fm=jpg" alt="ProfilePic">
            <br>
            <div style="font-size:20px;"> Tina Julie </div>
            <br>
            <!--Navigation Section-->
            <div id="nav">Home</div>
            ...
            <div id="profilebody">
                ...
                <div id="friendslist">TRAVELLERS
                    ...
                    <div>
                        <img src="https://images.pexels.com/photos/1382731/pexels-photo-1382731.jpeg?cs=srgb&dl=pexels-tu%E1%BA%A5n-ki%E1%BB%87t-jr-1382731.jpg&fm=jpg" alt="profile2" style="width:75px;">
                        <br>   <a href="Profile2.php">Zendaya Xui</a>
                    </div>
                    <div>
                        ...
                        <br>  <a href="Profile1.php">Sam Medndes</a>
                    </div>
                    <div>
                ...
                <!--Photos Section-->
                <div id="Photos">GREECE TRAVEL

                    <?php include "photosgreece.php"; ?>
